        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button onClick={toggleDarkMode} className="text-gray-600 dark:text-gray-300 hover:text-blue-600 transition-colors duration-200" title={isDarkMode ? "Modo Claro" : "Modo Oscuro"}>
                {isDarkMode ? <Sun size={24} /> : <Moon size={24} />}
              </button>
              <div className="relative">
                <button 
                  onClick={() => setIsLanguageMenuOpen(!isLanguageMenuOpen)} 
                  className="text-gray-600 dark:text-gray-300 hover:text-blue-600 transition-colors duration-200 flex items-center gap-2" 
            ...
            <button
              className="md:hidden p-2 rounded-md text-gray-600 dark:text-gray-300 hover:text-blue-600 hover:bg-gray-100"
          ...
          {isMenuOpen && (
            <div className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <button onClick={toggleDarkMode} className="block px-3 py-2 rounded-md text-gray-600 dark:text-gray-300 hover:text-blue-600 hover:bg-gray-100" title={isDarkMode ? "Modo Claro" : "Modo Oscuro"}>
                  {isDarkMode ? 'Modo Claro' : 'Modo Oscuro'}
                </button>
                <div className="relative">
                  <button onClick={() => setIsLanguageMenuOpen(!isLanguageMenuOpen)} className="block px-3 py-2 rounded-md text-gray-600 dark:text-gray-300 hover:text-blue-600 hover:bg-gray-100" title="Cambiar Idioma">
        ...
        <section id="inicio" className="relative py-24 bg-gradient-to-br from-blue-600 to-blue-700 dark:from-blue-700 dark:to-blue-800">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
            ...
            <div className="mt-10 flex justify-center space-x-4">
              <a href="#proyectos" className="bg-white text-blue-600 px-6 py-3 rounded-lg font-medium hover:bg-blue-50 transition-colors duration-200" title="Ver Proyectos">
