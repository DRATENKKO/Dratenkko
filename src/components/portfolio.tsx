...
const Portfolio = () => {
  ...
  const assistantLabel = language === 'es'
    ? 'Pregúntame sobre mi experiencia'
    : language === 'pt'
      ? 'Pergunte sobre minha experiência'
      : language === 'it'
        ? 'Chiedi della mia esperienza'
  ...
  return (
    <div className="portfolio-pro min-h-screen">
      ...
      <main id="main-content">
        ...
        <VisitorInsights language={language} />
