...
export const Projects = ({ language, onSelectProject }: ProjectsSectionProps) => {
  ...
  // Define featured projects (first 3)
  const featuredIds = ['artmind', 'sparedrive', 'prac'];
  ...
  return (
    <section id="proyectos" className="py-16 sm:py-20 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-deep-ocean relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-1/4 left-0 w-64 h-64 bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl animate-blob" />
        <div className="absolute bottom-1/4 right-0 w-64 h-64 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000" />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          ...
          >
            <span className="text-sm font-bold text-blue-700 dark:text-blue-300" aria-hidden="true">✨</span>
              ...
              >
                <TiltCard onClick={() => onSelectProject(project)}>
                  <div className="bg-white dark:bg-deep-ocean rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl hover:shadow-3xl transition-all duration-500 border-2 border-gray-200 dark:border-gray-700 relative h-full">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 via-purple-500/20 to-pink-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl sm:rounded-3xl" />
                    ...
                    <div className="relative aspect-video overflow-hidden bg-gradient-to-br from-blue-500 to-purple-600">
                      {project.videoUrl ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center text-white/50">
                          <svg className="w-12 h-12 sm:w-16 sm:h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      ...
                      {/* Featured Badge */}
                      {isFeatured && (
                        <div className="absolute top-2 sm:top-4 left-2 sm:left-4 px-2 sm:px-3 py-1 sm:py-1.5 bg-gradient-to-r from-amber-500 to-orange-500 rounded-lg text-xs font-bold text-white shadow-lg">
                          {language === 'en' ? 'Featured' : language === 'pt' ? 'Destaque' : language === 'it' ? 'In evidenza' : 'Destacado'}
                        </div>
                      )}
                    ...
                    <div className="p-4 sm:p-6 relative z-10">
                      ...
                      <div className="flex items-center gap-2 mb-3 sm:mb-4">
                        <Database size={14} className="text-blue-500 sm:w-4 sm:h-4" aria-hidden="true" />
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-xl font-semibold hover:shadow-xl transition-all"
          >
            <Github size={18} aria-hidden="true" />
            {language === 'en' ? 'View more on GitHub' : language === 'pt' ? 'Ver mais no GitHub' : language === 'it' ? 'Vedi altro su GitHub' : 'Ver más en GitHub'}
