...
export const Projects = ({ language, onSelectProject }: ProjectsSectionProps) => {
  ...
  return (
    <section id="proyectos" className="py-16 sm:py-20 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-deep-ocean">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-7xl mx-auto">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-deep-ocean rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl hover:shadow-3xl transition-all duration-500 cursor-pointer group border-2 border-gray-200 dark:border-gray-700 relative"
            >
