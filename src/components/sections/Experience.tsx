  ...
  return (
    <section id="experiencia" className="py-16 sm:py-20 bg-gray-50 dark:bg-deep-ocean relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-1/4 left-0 w-32 h-32 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl animate-blob" />
        <div className="absolute bottom-1/4 right-0 w-32 h-32 bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000" />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          ...
          <div className="w-24 sm:w-32 h-1 bg-gradient-to-r from-blue-600 to-purple-600 mx-auto rounded-full shadow-lg" />
        </motion.div>

        {/* Timeline Container */}
        <div className="max-w-4xl mx-auto relative">
          {/* Vertical Line - hidden on mobile, shown on sm+ */}
          <div className="hidden sm:block absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-500 via-purple-500 to-pink-500 transform -translate-x-1/2" />

          {/* Mobile vertical line */}
          <div className="sm:hidden absolute left-6 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-500 via-purple-500 to-pink-500" />
          ...
          <div className="space-y-8">
            {experience.map((exp, index) => {
              ...
              return (
                <motion.div
                  key={index}
                  initial={reducedMotion ? {} : { opacity: 0, x: isLeft ? -50 : 50 }}
                ...
                >
                  {/* Timeline Node */}
                  <div className="absolute left-6 sm:left-1/2 transform sm:-translate-x-1/2 z-10">
                    <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center shadow-lg border-4 border-white dark:border-gray-900">
                      <Briefcase size={20} className="text-white" aria-hidden="true" />
                    </div>
                  </div>
                  ...
                  <div className={`hidden sm:block sm:w-[calc(50%-2rem)] ${isLeft ? '' : 'sm:text-right'}`} />
                </motion.div>
              );
            })}
          </div>
          ...
          >
            <div className="w-16 h-16 bg-gradient-to-br from-pink-500 via-red-500 to-orange-500 rounded-full flex items-center justify-center shadow-xl border-4 border-white dark:border-gray-900 animate-pulse">
              <span className="text-2xl" role="img" aria-label="Continúa">🚀</span>
            </div>
          </motion.div>
        </div>
      </div>
